...
const Feedback = ({params}) => {
  ...
  return (
    <div className='p-10'>
      <h2 className='text-3xl font-bold text-green-600'>Fantastic work!</h2>
      <h2 className='font-bold text-2xl'>This is the feedback on your interview.</h2>
      ...
      {feedbackList&&feedbackList.map((item,index)=>(
        ...
        <CollapsibleContent>
          <div className='flex flex-col gap-2'>
            ...
            <h2 className='p-2 border rounded-lg bg-red-50 text-sm text-red-900'><strong>Your Response: </strong>{item.userAns}</h2>
            ...
            <h2 className='p-2 border rounded-lg bg-blue-50 text-sm text-primary'><strong>Suggestion Answer: </strong>{item.feedback}</h2>
          </div>
        </CollapsibleContent>
      </Collapsible>      
      ))}
